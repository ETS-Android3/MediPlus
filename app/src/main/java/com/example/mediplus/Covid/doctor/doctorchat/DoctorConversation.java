package com.example.mediplus.Covid.doctor.doctorchat;
...
import com.example.mediplus.Covid.user.talkto.adapter.MessageAdapter;
import com.example.mediplus.Covid.user.talkto.model.Chat;
...
public class DoctorConversation extends AppCompatActivity {
    TextView username;
    FirebaseUser fuser;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        documentReference = fStore.collection("users").document(doctorid);
        ...
        btn_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!msg.equals("")) {
                    ...
                    Toast.makeText(DoctorConversation.this, "You can't send empty message", Toast.LENGTH_SHORT).show();
                }
                text_send.setText("");
            }
        });
    ...
    private void readMessage(final String myid, final String doctorid) {
        ...
        fStore.collection("chats").orderBy("timestamp").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    messageAdapter = new MessageAdapter(DoctorConversation.this, mchat);
