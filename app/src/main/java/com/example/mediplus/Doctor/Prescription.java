...
import com.example.mediplus.Database.DatabaseHandler;
...
public class Prescription extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doctor_prescripe);

        a =  findViewById(R.id.a);
        b=  findViewById(R.id.b);
        c =  findViewById(R.id.c);

        mSubject =findViewById(R.id.sub);
        ...
        mUserRef = FirebaseDatabase.getInstance().getReference("Doctors").child(doctorId);
    ...
    public void insertSampleData(){
        ...
        databaseH.create( new MyObject("paracetamol") );
            ...
            mDatabase.setValue(userMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if(task.isSuccessful()){
                        startActivity(new Intent(Prescription.this, DoctorDashboard.class));
                        finish();
                    }
                    else {
