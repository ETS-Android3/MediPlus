...
public class Remind extends AppCompatActivity{
    ...
    public static void scheduleNotification(String id) {
        FirebaseDatabase.getInstance().getReference().child("Speciality").child(Objects.requireNonNull(FirebaseAuth.getInstance().getUid())).child(id).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot snapshot) {
                ...
                new NotifyMe.Builder(context)
                        ...
                        .addAction(new Intent(context.getApplicationContext(), Remind.class), "OK")
                        .time(time)
                        .build();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chipNavigationbar = findViewById(R.id.bottom_schedule_nav);
        chipNavigationbar.setItemEnabled(R.id.bottom_schedule_home, true);
      ...
      //  Objects.requireNonNull(getSupportActionBar()).setDisplayShowTitleEnabled(true);
       ...
       // navigationView.setCheckedItem(R.id.nav_remind);
        ...
        getSupportFragmentManager().beginTransaction().replace(R.id.fragment_contain, new HomeRemind()).commit();
        bottomMenu();
    }
    ...
    private void bottomMenu() {
        chipNavigationbar.setOnItemSelectedListener(new ChipNavigationBar.OnItemSelectedListener() {
            ...
            public void onItemSelected(int i) {
                ...
                switch (i) {
                    case R.id.bottom_schedule_home:
                        fragment = new HomeRemind();
                        break;
                    case R.id.bottom_schedule_add:
                        fragment = new AddRemind();
                        break;
                }
